...
set :repo_url, 'git@github.com:amadaneus/catlett_gallery.git'
set :branch, "master"

set :user, 'deploy'
set :application, 'catlett_gallery'
set :rails_env, 'production'
server '18.219.17.4', user: "#{fetch(:user)}", roles: %w{app db web}, primary: true
